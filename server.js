...
client.ownerst = ["586903396024320020"]; // KURUCU
client.evulate = []
...
client.botAccounts = ["902891903241060372","902889107846463519", "902892624233504798","902895279257288754","902895712092717177"] // Güvenli bot ID
client.botroles = ["902891903241060372","902889107846463519", "902892624233504798","902895279257288754","902895712092717177"] // YLER GİDİNCE YETKİSİ GİTMİYECEK BOTLARIN ID
let kanal = "902882720772915261" // LOG KANAL
let ustKanal = "902882720772915261" // YETKİSİ YETMEYİNCE BLABLA

client.on("ready", () => {
    client.user.setActivity("D İ E G O");
    console.log(client.user.tag)
    let botVoiceChannel = client.channels.cache.get("902882701017751612");
...
client.on("message", async message => {
    ...
    if (message.author.id !== "852924512013385749") return
